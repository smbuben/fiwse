...
class CountryData:
    ...
    def __init__(self):
        rawdata = [
            ...
            # Country           Pts     Ath     Ath
            # =========================================
            ('South Korea',     72.82,   62,     62),
            ('Austria',         52.92,  123,    123),
            ('Netherlands',     52.22,   51,     51),
            ('Norway',          49.45,  125,    125),
            ('Germany',         44.03,  157,    157),
            ('United States',   38.80,  260,    260),
            ('Russia',          36.91,  209,    209),
            ('Canada',          35.05,  224,    224),
            ('Sweden',          26.36,  112,    112),
            ('China',           23.45,   60,     60),
            ('Switzerland',     21.96,  167,    167),
            ('Croatia',         21.05,   11,     11),
            ('France',          19.82,  107,    107),
            ('Estonia',         18.04,   24,     24),
            ('Australia',       14.64,   58,     58),
            ('Poland',          13.46,   55,     55),
            ('Finland',         12.54,  110,    110),
            ('Italy',           11.16,  110,    110),
            ('Czech Republic',  10.76,   84,     84),
            ('Japan',            7.81,  115,    115),
            ('Belarus',          6.87,   25,     25),
            ('Slovenia',         5.42,   78,     78),
            ('Slovakia',         5.31,   63,     63),
            ('Great Britain',    5.06,   64,     64),
            ('Latvia',           3.50,   56,     56),
            ('Bulgaria',         1.98,   16,     16),
            ('Kazakhstan',       1.33,   45,     45),
            ('Albania',          1.00,    1,      1),
            ('Algeria',          1.00,    1,      1),
            ('Andorra',          1.00,    6,      6),
            ('Argentina',        1.00,    9,      9),
            ...
            ('Morocco',          1.00,    2,      2),
            ('Nepal',            1.00,    1,      1),
            ('New Zealand',      1.00,   22,     22),
            ('Pakistan',         1.00,    1,      1),
            ('Paraguay',         1.00,    1,      1),
            ('Peru',             1.00,    1,      1),
            ('Philippines',      1.00,    1,      1),
            ('Portugal',         1.00,    1,      1),
            ('Puerto Rico',      1.00,    1,      1),
            ('Romania',          1.00,   17,     17),
            ('San Marino',       1.00,    1,      1),
            ('Serbia',           1.00,    9,      9),
            ('Spain',            1.00,   18,     18),
            ('Chinese Taipei',   1.00,    2,      2),
            ('Tajikistan',       1.00,    1,      1),
            ('Thailand',         1.00,    1,      1),
            ('Togo',             1.00,    1,      1),
            ('Tonga',            1.00,    1,      1),
